...
import com.example.book_sell_website.dto.authen.request.AuthenticationRequest;
...
import com.example.book_sell_website.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(logInDTO request) {
        var user = userRepository
                .findUserByMail(request.getMail())
    ...
    public AuthenticationResponse refreshToken(RefreshRequest request) throws ParseException, JOSEException{
        ...
        var user = userRepository.findUserByMail(mail).orElseThrow(() -> new AppException(ErrorCode.UNAUTHENTICATED));
        var token = generateToken(user);
